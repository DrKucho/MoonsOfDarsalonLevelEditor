...
Shader "_Kucho/Sprites-Default HSVCD (DitherTexPos)"
{
     Properties
     {
...
//                col.rgb += _DitherColor.rgb * _DitherColor.a * pairMult * col.a; // dithering
                col.rgb = DitheringTex(IN.texcoord0, _MainTex_TexelSize.zw, col, _DitherColor);
//                col.rgb += _DitherColor.rgb * _DitherColor.a * GetDitherMultiplier(IN.texcoord0, _MainTex_TexelSize.zw );
