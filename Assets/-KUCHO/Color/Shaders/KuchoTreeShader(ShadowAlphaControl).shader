...
Shader "_Kucho/TreeShader(ShadowAlphaControl)" 
{
	Properties 
	{
        ...
        Pass {
            ...
            CGPROGRAM
                ...
                half4 Frag(posAndTwoCoords i) : COLOR
                {
                    ...
                    half  alpha01 = step(0.95, trueCol.a);
                    ...
                    //result.a = trueCol.a * alpha01 * _Alpha; // necesario hacerlo antes de llamar a dithering
                	result.a = saturate(alpha01 + (_Alpha * trueCol.a)); // intensidad de sombra/alpha
