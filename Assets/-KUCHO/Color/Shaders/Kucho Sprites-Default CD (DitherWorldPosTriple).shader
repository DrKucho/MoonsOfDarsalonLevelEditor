...
Shader "_Kucho/Sprites-Default CD (DitherWorldPosTriple)"
{
     Properties
     {
         ...
         _DitherColorMids ("_DitherColorMids", Color) = (1,1,1,0.025)
     ...
     SubShader
     {
		...
		CGPROGRAM
            ...
            half4 Frag(posTwoCoordsAndHSVMults IN) : COLOR
            {
                ...
                col.rgb = DitheringWorldTriple(IN.texcoord1, col, _DitherColorDarks, _DitherColorMids, _DitherColorBrights);  // Dithering basandose en la posicion en el mundo  
