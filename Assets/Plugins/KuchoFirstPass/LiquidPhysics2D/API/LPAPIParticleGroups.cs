...
public static class LPAPIParticleGroups
{
	...
	**/
	...
	#endif
	public static extern IntPtr CreateParticleGroup(IntPtr particlePointer, Int32 types, Int32 groupTypes, float angle, float strength, float angularVelocity, float linearVelocityX, float linearVelocityY, IntPtr shape, int r, int g, int b, int a, float stride, float lifetime, uint userdata); // KUCHO HACK el ultimo uint antes era int
