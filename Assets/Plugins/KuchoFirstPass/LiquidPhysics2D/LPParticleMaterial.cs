...
{
    [HideInInspector] public string at_name; // se fijara en play, para poder debuiguear
	...
	public float damagePower; // KUCHO HACK
    public float groundMakerCatalistPower;// KUCHO HACK
    public float pressure = 1f; // KUCHO HACK hace que los objetos pierdan gravity scale , asi es como consigo que floten ...?
    public float flamability = 0;
