...
public static class SWizTextGeomGen
{
	public class GeomData
	{
		internal SWizTextMeshData textMeshData = null;
		internal SWizFontData fontInst = null;
	...
	public static GeomData Data(SWizTextMeshData textMeshData, SWizFontData fontData, string formattedText) {
	...
	{
		SWizTextMeshData data = geomData.textMeshData;
		SWizFontData _fontInst = geomData.fontInst;
	...
	{
		SWizTextMeshData data = geomData.textMeshData;
		SWizFontData fontInst = geomData.fontInst;
