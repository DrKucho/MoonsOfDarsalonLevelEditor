...
public class SWizTiledSprite : SWizBaseSprite
{
	Mesh mesh;
	Vector2[] meshUvs;
	...
	new protected void SetColors(Color32[] dest)
	{
		int numVertices;
		int numIndices;
		SWizSpriteGeomGen.GetTiledSpriteGeomDesc(out numVertices, out numIndices, CurrentSprite, dimensions);
		SWizSpriteGeomGen.SetSpriteColors (dest, 0, numVertices, _color, collectionInst.premultipliedAlpha);
	}
	...
	public override void Build()
	{
		...
		int numVertices;
		int numIndices;
		SWizSpriteGeomGen.GetTiledSpriteGeomDesc(out numVertices, out numIndices, spriteDef, dimensions);
...
#endif
		SWizSpriteGeomGen.SetTiledSpriteGeom(meshVertices, meshUvs, 0, out boundsCenter, out boundsExtents, spriteDef, _scale, dimensions, anchor, colliderOffsetZ, colliderExtentZ);
		SWizSpriteGeomGen.SetTiledSpriteIndices(meshIndices, 0, 0, spriteDef, dimensions);
		...
		if (meshNormals.Length > 0 || meshTangents.Length > 0) {
			...
			SWizSpriteGeomGen.SetSpriteVertexNormals(meshVertices, meshVertexMin, meshVertexMax, spriteDef.normals, spriteDef.tangents, meshNormals, meshTangents);
		}
...
#region Collider
	...
	public override void ReshapeBounds(Vector3 dMin, Vector3 dMax) { // Identical to SWizSlicedSprite.ReshapeBounds
