...
public static class SWizSpriteGeomGen
{
	// Common
	...
	public static Vector2 GetAnchorOffset( SWizBaseSprite.Anchor anchor, float width, float height ) {
		Vector2 anchorOffset = Vector2.zero;

		switch (anchor) {
		case SWizBaseSprite.Anchor.LowerLeft: case SWizBaseSprite.Anchor.MiddleLeft: case SWizBaseSprite.Anchor.UpperLeft: 
			break;
		case SWizBaseSprite.Anchor.LowerCenter: case SWizBaseSprite.Anchor.MiddleCenter: case SWizBaseSprite.Anchor.UpperCenter: 
			anchorOffset.x = (int)(width / 2.0f); break;
		case SWizBaseSprite.Anchor.LowerRight: case SWizBaseSprite.Anchor.MiddleRight: case SWizBaseSprite.Anchor.UpperRight: 
			anchorOffset.x = (int)(width); break;
		}
		switch (anchor) {
		case SWizBaseSprite.Anchor.UpperLeft: case SWizBaseSprite.Anchor.UpperCenter: case SWizBaseSprite.Anchor.UpperRight:
			break;
		case SWizBaseSprite.Anchor.MiddleLeft: case SWizBaseSprite.Anchor.MiddleCenter: case SWizBaseSprite.Anchor.MiddleRight:
			anchorOffset.y = (int)(height / 2.0f); break;
		case SWizBaseSprite.Anchor.LowerLeft: case SWizBaseSprite.Anchor.LowerCenter: case SWizBaseSprite.Anchor.LowerRight:
	...
	// Sprite
	public static void GetSpriteGeomDesc(out int numVertices, out int numIndices, SWizSpriteDefinition spriteDef)
	{
		numVertices = spriteDef.positions.Length;
		numIndices = spriteDef.indices.Length;
	}

	public static void SetSpriteGeom(Vector3[] pos, Vector2[] uv, Vector3[] norm, Vector4[] tang, int offset, SWizSpriteDefinition spriteDef, Vector3 scale)
	{
	...
	public static void SetSpriteIndices(int[] indices, int offset, int vStart, SWizSpriteDefinition spriteDef)
	{
	...
	public static void GetClippedSpriteGeomDesc(out int numVertices, out int numIndices, SWizSpriteDefinition spriteDef)
	{
	...
	public static void SetClippedSpriteGeom( Vector3[] pos, Vector2[] uv, int offset, out Vector3 boundsCenter, out Vector3 boundsExtents, SWizSpriteDefinition spriteDef, Vector3 scale, Vector2 clipBottomLeft, Vector2 clipTopRight, float colliderOffsetZ, float colliderExtentZ )
	{
		...
		if (spriteDef.positions.Length == 4)
		{
			...
			if (spriteDef.flipped == SWizSpriteDefinition.FlipMode.SWiz)
			{
			...
			else if (spriteDef.flipped == SWizSpriteDefinition.FlipMode.TPackerCW)
			{
				Vector2 v0 = new Vector2(Mathf.Lerp(spriteDef.uvs[0].x, spriteDef.uvs[3].x, fracBottomLeft.y),
				                         Mathf.Lerp(spriteDef.uvs[0].y, spriteDef.uvs[3].y, fracBottomLeft.x));
				Vector2 v1 = new Vector2(Mathf.Lerp(spriteDef.uvs[0].x, spriteDef.uvs[3].x, fracTopRight.y),
	...
	public static void SetClippedSpriteIndices( int[] indices, int offset, int vStart, SWizSpriteDefinition spriteDef)
	{
		if (spriteDef.positions.Length == 4)
		{
	...
	public static void GetSlicedSpriteGeomDesc(out int numVertices, out int numIndices, SWizSpriteDefinition spriteDef, bool borderOnly)
	{
		if (spriteDef.positions.Length == 4)
		{
			numVertices = 16;
	...
	public static void SetSlicedSpriteGeom(Vector3[] pos, Vector2[] uv, int offset, out Vector3 boundsCenter, out Vector3 boundsExtents, SWizSpriteDefinition spriteDef, Vector3 scale, Vector2 dimensions, Vector2 borderBottomLeft, Vector2 borderTopRight, SWizBaseSprite.Anchor anchor, float colliderOffsetZ, float colliderExtentZ)
	{
		boundsCenter = Vector3.zero;
		boundsExtents = Vector3.zero;
		if (spriteDef.positions.Length == 4)
	...
	public static void SetSlicedSpriteIndices(int[] indices, int offset, int vStart, SWizSpriteDefinition spriteDef, bool borderOnly)
	{
		if (spriteDef.positions.Length == 4)
		{
	...
	public static void GetTiledSpriteGeomDesc(out int numVertices, out int numIndices, SWizSpriteDefinition spriteDef, Vector2 dimensions)
	{
	...
	public static void SetTiledSpriteGeom(Vector3[] pos, Vector2[] uv, int offset, out Vector3 boundsCenter, out Vector3 boundsExtents, SWizSpriteDefinition spriteDef, Vector3 scale, Vector2 dimensions, SWizBaseSprite.Anchor anchor, float colliderOffsetZ, float colliderExtentZ)
	{
		boundsCenter = Vector3.zero;
		boundsExtents = Vector3.zero;
	...
	public static void SetTiledSpriteIndices(int[] indices, int offset, int vStart, SWizSpriteDefinition spriteDef, Vector2 dimensions)
	{
		int numVertices;
		int numIndices;
	...
	public static void SetSpriteDefinitionMeshData(Vector3[] pos, int[] indices, int posOffset, int indicesOffset, int vStart, SWizSpriteDefinition spriteDef, Matrix4x4 mat, Vector3 baseScale)
	{
