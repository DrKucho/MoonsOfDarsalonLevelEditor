...
/// </summary>
public class SWizCameraSettings {
...
/// </summary>
public class SWizCameraResolutionOverride {
	/// <summary>
	...
	/// <summary>
	/// Returns true if this instance of SWizCameraResolutionOverride matches the curent resolution.
	...
	public static SWizCameraResolutionOverride DefaultOverride {
		get {
			SWizCameraResolutionOverride res = new SWizCameraResolutionOverride();
			res.name = "Override";
